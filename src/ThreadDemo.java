...
public class ThreadDemo {
    public static void main(String[] args) {
        ...
        printer.setDaemon(true); // This will make the thread demoen which will exit on exitting the main method.
        ...
        anotherPrinter.setDaemon(true);
        anotherPrinter.setMessage("I am fine");
        anotherPrinter.start();
        System.out.println(anotherPrinter.getName());
